...
const stateFoods = [
  ...
  },
  {
    state: "Bihar",
    food: "Litti Chokha",
    restaurant: "Biryani Mahal & Litti House",
    price: "₹150-₹500",
  },
  {
    state: "Chhattisgarh",
  ...
  },
  {
    ...
    restaurant: "Pousada by the Beach",
    price: "₹600-₹1800",
  },
  {
    state: "Gujarat",
  ...
  },
  {
    ...
    food: "Poha Jalebi",
    restaurant: "Shreemaya Celebration",
    price: "₹200-₹700",
  },
  {
    state: "Maharashtra",
  ...
  },
  {
    state: "Meghalaya",
    food: "Jadoh",
    restaurant: "Dylan's Cafe",
    price: "₹300-₹900",
  },
  {
    state: "Mizoram",
    food: "Bai",
    restaurant: "Aizawl Kitchen",
    price: "₹250-₹650",
  },
  {
    state: "Nagaland",
    food: "Smoked Pork with Bamboo Shoot",
    restaurant: "Hornbill Restaurant",
    price: "₹350-₹1000",
  },
  {
    state: "Odisha",
        ...
        <div className="sticky top-0 z-10 flex items-start justify-between gap-4 border-b border-slate-800 bg-slate-950/95 px-5 py-5 md:px-8">
          <div>
            ...
            <p className="mt-2 max-w-3xl text-sm md:text-base text-slate-400">
              Click a state to search on Google Maps for a recommended
              restaurant and signature food. Prices are indicative per person.
            </p>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="max-h-[calc(92vh-110px)] overflow-y-auto px-5 py-6 md:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4 md:gap-5">
            {stateFoods.map((item) => (
              <article
                key={item.state}
                className="rounded-2xl border border-slate-800 bg-slate-900/70 p-4 md:p-5 hover:border-emerald-500/30 transition-colors"
              >
